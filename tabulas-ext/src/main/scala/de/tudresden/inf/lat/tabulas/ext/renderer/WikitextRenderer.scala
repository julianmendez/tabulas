...
import de.tudresden.inf.lat.tabulas.datatype.{CompositeTypeValue, ParameterizedListValue, PrimitiveTypeValue, Record}
import de.tudresden.inf.lat.tabulas.datatype.{StringType, StringValue, URIType, URIValue}
